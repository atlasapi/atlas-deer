...
public class ScheduleBlockUpdaterTest {
    ...
    public void testNoStaleEntriesWhenPreviousScheduleIsEmpty() throws Exception {
        ...
        ScheduleBlocksUpdate scheduleUpdate = updater.updateBlocks(
                currentSchedule,
                ImmutableList.<ChannelSchedule>of(),
                ImmutableList.of(updateEntry),
                channel,
                interval
        );
        ...
        assertThat(
                Iterables.getOnlyElement(scheduleUpdate.getUpdatedBlocks().get(0).getEntries()),
                is(updateEntry)
        );
    }
    ...
    public void testNoStaleEntriesWhenPreviousScheduleMatchesCurrent() throws Exception {
        ...
        List<ChannelSchedule> currentSchedule = ImmutableList.of(new ChannelSchedule(
                channel,
                interval,
                entries
        ));
    ...
    public void testStaleEntryReplacedWhenBroadcastIdChanges() throws Exception {
        ...
        ItemAndBroadcast currentEntry = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "one",
    ...
    public void testUpdatesWhenBroadcastOverlapUpdateIntervalStart() throws Exception {
        ...
        ItemAndBroadcast currentEntry = itemAndBroadcast(
                ...
                channel,
                "one",
                new Interval(0, 100, DateTimeZones.UTC)
        );
        List<ChannelSchedule> currentSchedule = ImmutableList.of(new ChannelSchedule(
                channel,
                interval,
    ...
    public void testPutsBroadcastSpanningTwoBlocksInBothBlocks() throws Exception {
        ...
        ItemAndBroadcast updateEntry = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "one",
                new Interval(100, 200, DateTimeZones.UTC)
        );
        ...
        ScheduleBlocksUpdate scheduleUpdate = updater.updateBlocks(
                ...
                ImmutableList.of(updateEntry),
                channel,
                new Interval(interval1.getStart(), interval2.getEnd())
        );
        ...
        assertThat(
                Iterables.getOnlyElement(scheduleUpdate.getUpdatedBlocks().get(1).getEntries()),
                is(updateEntry)
        );
        assertTrue(scheduleUpdate.getStaleEntries().isEmpty());
    }
    ...
    public void testDoesntPutBroadcastInOneBlockInBothBlocks() throws Exception {
        ...
        ItemAndBroadcast updateEntry = itemAndBroadcast(
                ...
                channel,
                "one",
                new Interval(25, 100, DateTimeZones.UTC)
        );
    ...
    public void testItemsAreSortedInBlock() throws Exception {
        ...
        ItemAndBroadcast episodeAndBroadcast1 = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "one",
        ...
        ItemAndBroadcast episodeAndBroadcast2 = itemAndBroadcast(
                2,
                METABROADCAST,
                channel,
                "two",
        ...
        ItemAndBroadcast episodeAndBroadcast3 = itemAndBroadcast(
                3,
                METABROADCAST,
                channel,
                "two",
        ...
        ScheduleBlocksUpdate scheduleUpdate = updater.updateBlocks(
                currentSchedule,
                ImmutableList.<ChannelSchedule>of(),
                ImmutableList.of(episodeAndBroadcast3),
                channel,
                overwrittenInterval
        );

        assertThat(
                scheduleUpdate.getUpdatedBlocks().get(0).getEntries().get(0),
                is(episodeAndBroadcast1)
        );
        assertThat(
                scheduleUpdate.getUpdatedBlocks().get(0).getEntries().get(1),
                is(episodeAndBroadcast3)
        );
    ...
    public void testItemWithUpdatedBroadcastTimeDoesntAppearTwice() throws Exception {
        ...
        ItemAndBroadcast iab1 = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "one",
        ...
        ItemAndBroadcast iab2 = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "one",
                new Interval(5, 105, DateTimeZones.UTC)
        );
    ...
    public void testItemCanAppearMultipleTimesInASchedule() throws Exception {
        ...
        ItemAndBroadcast iab3 = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "three",
                new Interval(200, 300, DateTimeZones.UTC)
        );

        ItemAndBroadcast iab4 = itemAndBroadcast(
                2,
                METABROADCAST,
                channel,
                "four",
        ...
        ScheduleBlocksUpdate update = updater.updateBlocks(
                currentSchedule,
                ImmutableList.<ChannelSchedule>of(),
                updateEntries,
                channel,
    ...
    public void testStaleEntryOnlyAppearsOnceInStaleEntries() throws Exception {
        ...
        ItemAndBroadcast episode1 = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "one",
                new Interval(0, 200, DateTimeZones.UTC)
        );
        ...
        ItemAndBroadcast episode2 = itemAndBroadcast(
                2,
                METABROADCAST,
                channel,
                "one",
    ...
    public void testPastBlocksAppearInStaleEntries() throws Exception {
        ...
        ItemAndBroadcast episode4 = itemAndBroadcast(
                1,
                METABROADCAST,
                channel,
                "three",
    ...
    public void testDontMarkAsStaleBroadcastsOutsideTheUpdateInterval() throws Exception {
        ...
        ItemAndBroadcast episode1 = itemAndBroadcast(
                ...
                channel,
                "one",
                new Interval(episode1Start, episode1End)
        );
        ItemAndBroadcast episode2 = itemAndBroadcast(
                2,
                METABROADCAST,
                channel,
                "two",
                new Interval(episode2Start, episode2End)
        );
        ItemAndBroadcast episode3 = itemAndBroadcast(
                3,
                METABROADCAST,
        ...
        ItemAndBroadcast episode4 = itemAndBroadcast(
                ...
                channel,
                "four",
                new Interval(episode4Start, episode4End)
        );
        ItemAndBroadcast episode5 = itemAndBroadcast(
                5,
                METABROADCAST,
                channel,
                "five",
                new Interval(episode5Start, episode5End)
        );
    ...
    private ItemAndBroadcast itemAndBroadcast(int id, Publisher source, Channel channel, String bId,
            Interval interval) {

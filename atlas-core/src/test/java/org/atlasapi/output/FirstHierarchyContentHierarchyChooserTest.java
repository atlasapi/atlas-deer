...
public class FirstHierarchyContentHierarchyChooserTest {
    ...
    public void testFirstBrandWithHierarchyChosen() {
        ...
        Optional<Container> chosen = underTest.chooseBestHierarchy(ImmutableList.of(
                mostPrecedentWithoutSeries,
                lessPrecedentWithSeries
        ));
    ...
    public void testFallbackUsedIfNoHiearchyFound() {
        ...
        ImmutableList<Container> containers = ImmutableList.of(
                mostPrecedentWithoutSeries,
                lessPrecedentWithoutSeries
        );

...
/**
 * Strategy for selecting which container in an equivalent set should be used for series and items
 */
public interface EquivalentSetContentHierarchyChooser {
     ...
     *
     * @param containers Containers in the equivalent set, ordered by precedence

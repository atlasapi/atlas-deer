...
public class SearchQueryV5 {
    ...
    public static class Builder {
        ...
        public SearchQueryV5 build() {
            return new SearchQueryV5(query,
                    selection,
                    specializations,
                    publishers,
                    title,
     ...
     */
    @Deprecated
    public SearchQueryV5(String term, Selection selection, float titleWeighting,
     ...
     */
    @Deprecated
    public SearchQueryV5(String term, Selection selection, Iterable<Publisher> includedPublishers,
    ...
    public SearchQueryV5(String term, Selection selection,

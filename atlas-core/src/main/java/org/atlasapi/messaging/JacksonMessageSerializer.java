...
public class JacksonMessageSerializer<M extends Message> implements MessageSerializer<M> {
    ...
    public static class MessagingModule extends SimpleModule {
        ...
        public MessagingModule() {
            super(
                    "Messaging Module",
                    new com.fasterxml.jackson.core.Version(0, 0, 1, null, null, null)
            );
        }
        ...
        public void setupModule(Module.SetupContext context) {
            ...
            context.setMixInAnnotations(
                    ...
                    ResourceUpdatedMessageConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalenceGraphUpdateMessage.class,
                    EquivalenceGraphUpdateMessageConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalentContentUpdatedMessage.class,
                    EquivalentContentUpdatedMessageConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalenceGraph.class,
                    EquivalenceGraphConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalenceGraph.Adjacents.class,
                    AdjacentsConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalenceGraphUpdate.class,
                    EquivalenceGraphUpdateConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalenceGraphUpdate.Builder.class,
                    EquivalenceGraphUpdateConfiguration.Builder.class
            );
            context.setMixInAnnotations(
            ...
            context.setMixInAnnotations(
                    ScheduleUpdate.Builder.class,
                    ScheduleUpdateConfiguration.Builder.class
            );
            context.setMixInAnnotations(
                    EquivalenceAssertionMessage.class,
                    EquivalenceAssertionMessageConfiguration.class
            );
            context.setMixInAnnotations(
                    EquivalenceAssertionMessage.Builder.class,
                    EquivalenceAssertionMessageConfiguration.Builder.class
            );
        }
    ...
    public static final <M extends Message> JacksonMessageSerializer<M> forType(
            Class<? extends M> cls) {

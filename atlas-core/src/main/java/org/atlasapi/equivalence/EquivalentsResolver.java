...
/**
 * A content resolver which returns the equivalent set for each requested identifiers inside the
 * given set of sources.
 */
public interface EquivalentsResolver<E extends Equivalable<E>> {

    /**
     * Resolves the equivalent sets of content for a given set of source URIs. Only content from the
     * given sources is resolved.
     *

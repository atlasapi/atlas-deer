...
public enum EntityType {
    ...
    private static Map<String, EntityType> STRING_LOOKUP = Maps.uniqueIndex(ImmutableList.copyOf(
            values()), Functions.toStringFunction());

    private static Map<Class<? extends Described>, EntityType> CLASS_LOOKUP = Maps.uniqueIndex(
            ImmutableList.copyOf(values()),
            new Function<EntityType, Class<? extends Described>>() {

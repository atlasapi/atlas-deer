...
public class CrewMember extends Identified implements Hashable {
    ...
    public enum Role {
        ...
        ADVERTISING_PRODUCTION_COMPANY(
                "advertising_production_company",
        ...
        PROGRAMME_PRODUCTION_RESEARCHER(
                "programme_production_researcher",
        ...
        ASSISTANT_CHIEF_LIGHTING_TECHNICIAN(
                "assistant_chief_lighting_technician",
    ...
    public static CrewMember crewMember(String id, String name, String roleKey,
            Publisher publisher) {
    ...
    public Person toPerson() {
        return new Person(this.getCanonicalUri(), this.getCurie(), this.publisher()).withName(name)
                .withProfileLinks(profileLinks());
    }

...
public class AstyanaxProtobufContentMarshaller
        extends ProtobufContentMarshaller<ColumnListMutation<String>, ColumnList<String>> {

    public AstyanaxProtobufContentMarshaller(
            Serializer<Content, ContentProtos.Content> serialiser) {
        super(serialiser);
    }

    @Override
    protected void addColumnToBatch(ColumnListMutation<String> mutation, Id id, String column,
            byte[] value) {

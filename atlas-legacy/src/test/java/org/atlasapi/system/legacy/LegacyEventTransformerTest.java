...
public class LegacyEventTransformerTest {
    ...
    private void checkEvent(org.atlasapi.event.Event event, Event input) {
        ...
        assertThat(event.getContent().get(0).getId().longValue(), is(input.content().get(0).getId()));

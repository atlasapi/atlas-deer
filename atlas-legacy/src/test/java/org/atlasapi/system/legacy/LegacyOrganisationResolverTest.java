...
public class LegacyOrganisationResolverTest {
    ...
    public void testResolvingOrganisations() throws Throwable {
        ...
        FluentIterable<org.atlasapi.organisation.Organisation> organisations = resources.get()
                .getResources();
        assertThat(organisations.size(), is(1));
        assertThat(
                organisations.first().get().getAlternativeTitles(),
                is(legacyOrganisation.getAlternativeTitles())
        );
    }
}
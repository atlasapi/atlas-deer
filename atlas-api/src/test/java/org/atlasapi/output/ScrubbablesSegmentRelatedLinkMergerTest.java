...
public class ScrubbablesSegmentRelatedLinkMergerTest {
    ...
    public void testOverlappingSegmentRelatedLinksAreReturnedInSortedOrder() throws Exception {
        ...
        selectedSegment.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "canonical").build()));
        ...
        tempSeg.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "notCanonicalButOverlaps").build()));
    ...
    public void testOnlyOverlappingSegmentRelatedLinksAreReturnedInSortedOrder() throws Exception {
        ...
        tempSeg.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "notCanonicalAndDoesntOverlap").build()));
    ...
    public void testSortedOrderRelatedLinks() throws Exception {
        ...
        selectedSegment.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "full").build()));
        ...
        tempSeg.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "30").build()));
        ...
        tempSeg.setDuration(Duration.standardSeconds(1L));
        tempSeg.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "0").build()));
        tempSegEvent.setOffset(Duration.standardSeconds(-100L));
        segmentMap.put(tempSeg, tempSegEvent);
        ...
        tempSeg.setRelatedLinks(ImmutableList.of(RelatedLink.relatedLink(RelatedLink.LinkType.ARTICLE, "10").build()));

...
//        refresh(esClient.client());
//
//        Set<AttributeQuery<?>> query = AttributeQuerySet.create(ImmutableList.of(
...
//                query,
//                ImmutableList.of(Publisher.DBPEDIA),
//                Selection.ALL
//        ));
...
//    }
//
//    private Topic topic(int id, Publisher source, String title, String description,
//            Alias... aliases) {

...
//        contentIndexer = EsUnequivalentContentIndex.create(
//                esClient.client(),
...
//
//        episodeOne.setBroadcasts(ImmutableSet.of(new Broadcast(
//                Id.valueOf(100l),
//                now,
//                nowPlusOneDay
//        )));
...
//
//        GetResponse respTwo = esClient.client()
//                .get(new GetRequest("content", "container", "1"))
//                .get();
...
//        GetResponse respThree = esClient.client()
//                .get(new GetRequest("content", "container", "1"))
//                .get();

...
public class ResponseWriterFactory {
    ...
    private final Map<String, MimeType> extensionMap = ImmutableMap.of(
            ".json",
    ...
    private ResponseWriter writerFromAcceptHeader(HttpServletRequest request,
    ...
    private ResponseWriter writerFromExtension(HttpServletRequest request,

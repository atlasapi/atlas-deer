...
public class ModelController {
    ...
    public ModelController(ModelClassInfoStore classInfoStore, QueryResultWriter<ModelClassInfo> resultWriter, 
    ...
    private QueryResult<ModelClassInfo> createListResultFrom(Iterable<ModelClassInfo> resources, HttpServletRequest request)
    ...
    private ModelClassInfo resolveResource(HttpServletRequest request, String key) throws QueryExecutionException {
    ...
    private QueryResult<ModelClassInfo> createSingleResultFrom(ModelClassInfo resource, HttpServletRequest request)
            throws QueryParseException, InvalidApiKeyException {
